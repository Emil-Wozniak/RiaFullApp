...
@Service
public class ExaminationPointService extends FileExtractorImpl<ExaminationPoint> implements CustomFileReader {
     ...
     */
    public List<ExaminationPoint> create(List<String> metadata, List<ControlCurve> controlCurves) {
