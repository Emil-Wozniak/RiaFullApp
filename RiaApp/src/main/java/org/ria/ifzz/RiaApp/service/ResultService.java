...
public class ResultService {
     ...
     */
    public Result createResultFromColumnsLength(List<String> list, Backlog backlog) {
        ...
        for (String line : list) {
            if (line.startsWith(" \tUnk")) {
                ...
                result.setFileName("row_" + list.indexOf(line));
     ...
     */
    public Result assignCcmpToResult(List<String> list, FileEntity fileEntity) {
        ...
        for (int i = 0; i < list.size() - 1; i++) {
            ...
            int index = i + 1;
            result = resultRepository.findByFileName("row_" + index);
