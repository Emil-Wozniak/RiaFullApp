...
public class ResultService {
     ...
     * @param file
     */
    public List<Result> assignDataToResult(List<String> list, @NotNull MultipartFile file, FileEntity fileEntity, List<Result> results) {
    ...
    public List<Result> setDataToResult(@NotNull MultipartFile file, List<String> list, Backlog backlog, FileEntity fileEntity) {
        ...
        List<Result> resultsWithData = assignDataToResult(list,file,fileEntity,results);
