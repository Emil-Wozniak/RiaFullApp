...
public class ResultService {
    ...
    public Iterable<Result> getFileDataById(String dataId) throws FileNotFoundException {
        fileEntityService.getFileEntityByDataId(dataId);
     ...
     */
    public Result createResultFromColumnsLength(List<String> list, MultipartFile file, Backlog backlog) {
     ...
     * @param file uploaded file
     */
    public Result assignCcmpToResult(List<String> list, MultipartFile file, FileEntity fileEntity) {
